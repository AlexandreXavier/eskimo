    ...
    public class ButtonBarSkin extends MobileSkin
    {
        ...
        override protected function createChildren():void
        {
            ...
            if (!firstButton)
            {
                ...
                firstButton.skinClass = com.piaction.skins.mobile.ios.ButtonBarFirstButtonSkin;
            }
            
            if (!lastButton)
            {
                lastButton = new ButtonBarButtonClassFactory(ButtonBarButton);
                lastButton.skinClass = com.piaction.skins.mobile.ios.ButtonBarLastButtonSkin;
            }
            
            if (!middleButton)
            {
                middleButton = new ButtonBarButtonClassFactory(ButtonBarButton);
                middleButton.skinClass = com.piaction.skins.mobile.ios.ButtonBarMiddleButtonSkin;
            }
